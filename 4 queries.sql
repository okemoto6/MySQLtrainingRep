...
-- #2 - Which equipment I've used most in 2021?
...
-- #3 - Want to brew sth but the weather is hot, show me yeast strains with highest fermentation temperatures.
...
-- #4 - I would like to brew a crystal clear lager. I remember that I've already brewed one and it came out great but don't remember which batch was it and which yeast I've used. Can you help with that?
...
-- #5 - Want to make a gift for a friend but he doesn't like bitter beer. Please show me a list of previous batches that I could brew again
